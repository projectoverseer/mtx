...
* **mtx Tracks** -- one page per analysed folder.  ~150 queryable properties,
  and the full 2,000-column row, section timeline, chord track and confidence
  notes in the page body.
* **mtx Observations** -- append-only.  One row per time-varying figure per
...
TRACKS_DB = "mtx Tracks"
OBSERVATIONS_DB = "mtx Observations"
